...
const Packages = () => {
    ...
    return (
        <div className="container mx-auto">
            <h1 data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" className="text-5xl text-center my-10 font-bold">Hotel Hydra Resort <span className="text-[#B8860B]">Hot Packages</span> in <span className="text-[#B8860B]">Cox's Bazar</span></h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div data-aos="flip-left"data-aos-easing="ease-out-cubic"data-aos-duration="2000" className="rounded-t-[100px] card-compact bg-orange-100 shadow-xl border-t-8 border-[#B8860B] hover:border-lime-500">
                ...
                <div data-aos="flip-right"data-aos-easing="ease-out-cubic"data-aos-duration="2000" className="rounded-t-[100px] card-compact bg-orange-100 shadow-xl border-t-8 border-[#B8860B] hover:border-lime-500">
